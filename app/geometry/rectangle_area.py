def parse_number(value: str) -> float:
    """
    Проверка корректности ввода строны прямоугольника
    param value: пользовательский ввод длина стороны прямоугольника
    return: number: длина стороны прямоугольника (тип float)
    """
    try:
